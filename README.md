...
I’m **Kousik Kar**, an **Electronics and Communication Engineering (ECE)** undergraduate student at **Jadavpur University (Batch of 2028)**, with interests in **Digital Design, FPGA, VLSI systems**, and **AI/ML**.

My goal is to develop **robust RTL design fundamentals**—understanding not only *how* to write Verilog, but *why* the hardware works the way it does—while maintaining clean, modular, and synthesizable designs.
